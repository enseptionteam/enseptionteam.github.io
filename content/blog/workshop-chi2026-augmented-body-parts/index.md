...
image:
  caption: "[W7: Augmented Body Parts: Bridging VR Embodiment and Wearable
    Robotics](https://sites.google.com/view/augmented-body-parts) at CHI 2026,
    Barcelona"
authors:
  - admin
tags:
...
The discussion centered on two complementary themes:

- Embodiment and adaptation with virtually augmented body parts, including control mappings, sensory feedback, training strategies, and the limits of human plasticity when body form diverges from the human template.
- Bridging virtual embodiment to wearable robotics, including which VR-derived strategies transfer to physical systems, what evidence best predicts successful on-body use, and how interaction artifacts such as mappings, feedback parameters, and logs should be structured for reuse.
...
This workshop was organized through an international, multi-institutional collaboration between:
...
- Hongyu Zhou, School of Computer Science, The University of Sydney, Sydney, Australia
- Marie Muehlhaus, Saarland University, Saarland Informatics Campus, Saarbrucken, Germany
- Eyal Ofek, School of Computer Science, University of Birmingham, Birmingham, United Kingdom
